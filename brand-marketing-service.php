...
<html lang="en">
   ...
   <body>
      ...
      <section class="mainBanner">
         ...
         <div class="container">
            <h1 class="gs_reveal gs_reveal_fromDown"><span>Branding</span></h1>
      ...
      <section class="service-detail">
          <div class="container">
              <div class="row">
                  <div class="col-md-6">
                       <h4 class="gs_reveal gs_reveal_fromLeft">unforgettable <span>brand</span> identity</h4>
                       <p class="gs_reveal gs_reveal_fromLeft">We develop branding that distinguishes your business. Our team crafts compelling visual identities and messaging that resonate with your audience and reflect your values. Let us help you establish a brand that resonates long-term.</p>
                       <p class="gs_reveal gs_reveal_fromLeft">At Teknocide, we craft exceptional brand identities tailored to your business. Our expert team ensures your brand is memorable, cohesive, and aligned with your vision.</p>
                  </div>
                  <div class="col-md-6">
      ...
      <section class="aboutsec servicedetailsec">
         <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h4 class="gs_reveal gs_reveal_fromLeft">Strategic <span>Branding</span> Solutions</h4>
                     <p class="gs_reveal gs_reveal_fromLeft">Teknocide doesn’t just create logos; we build brands. By understanding your market and goals, we develop branding that is not only attractive but also strategically positioned for success. Strengthen your brand presence with us.</p>
                </div>
