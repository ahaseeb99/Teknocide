   ...
   <body>
    ...
    <!-- End Google Tag Manager (noscript) -->
      ...
      <section class="mainBanner">
         ...
         <div class="container">
            <h1 class="gs_reveal gs_reveal_fromDown"><span>seo</span></h1>
      ...
      <section class="service-detail">
          <div class="container">
              <div class="row">
                  <div class="col-md-6">
                       <h4 class="gs_reveal gs_reveal_fromLeft">Proven <span>SEO</span> Techniques</h4>
                       <p class="gs_reveal gs_reveal_fromLeft">We design SEO strategies that improve your search engine rankings and drive organic traffic. Our team uses the latest techniques to ensure your website is easily discoverable. Let us help you boost your online visibility.</p>
                       <p class="gs_reveal gs_reveal_fromLeft">We develop SEO plans that yield results. By understanding your business and audience, we implement strategies that enhance your search presence. Improve your SEO with us.</p>
                  </div>
                  <div class="col-md-6">
      ...
      <section class="aboutsec servicedetailsec">
         <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h4 class="gs_reveal gs_reveal_fromLeft">effective <span>seo</span> solutions</h4>
                     <p class="gs_reveal gs_reveal_fromLeft">At Teknocide, we craft exceptional SEO strategies tailored to your business. Our expert team ensures your site ranks higher, attracts more visitors, and converts them into customers. Experience innovative SEO and sustainable growth with us.</p>
                </div>
