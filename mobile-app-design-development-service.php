   ...
   <body>
    ...
    <!-- End Google Tag Manager (noscript) -->
      ...
      <section class="mainBanner">
         ...
         <div class="container">
            <h1 class="gs_reveal gs_reveal_fromDown">Mobile <span>App</span> Design</h1>
      ...
      <section class="service-detail">
          <div class="container">
              <div class="row">
                  <div class="col-md-6">
                       <h4 class="gs_reveal gs_reveal_fromLeft">INNOVATIVE <span>MOBILE</span> SOLUTIONS</h4>
                       <p class="gs_reveal gs_reveal_fromLeft">We design and develop mobile apps that captivate and engage users. Our team ensures 	each app delivers a seamless, intuitive experience, enhancing your presence in the mobile domain.</p>
                       <p class="gs_reveal gs_reveal_fromLeft">Teknocide doesn't just create apps; we build tools for success. By understanding your audience and business goals, we develop apps that are visually stunning and functionally superior. Enhance your mobile strategy with us.</p>
                  </div>
                  <div class="col-md-6">
      ...
      <section class="aboutsec servicedetailsec">
         <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <h4 class="gs_reveal gs_reveal_fromLeft">DYNAMIC <span>MOBILE</span> EXPERIENCES</h4>
                     <p class="gs_reveal gs_reveal_fromLeft">At Teknocide, we craft exceptional mobile apps tailored to your business needs. Our expert team ensures your app is engaging, intuitive, and optimized for success. Experience innovative design and seamless functionality with us.</p>
                </div>
